export function bar(params) {
  ...
  var bars = svg
    ...
    .attr("x", function (d) {
      return x(d.dimension_values);
    })
    .attr("width", x.bandwidth())
    .attr("y", function (d) {
      return y(d.measure_count);
    })
    .attr("height", function (d) {
      return height - y(d.measure_count);
    })
  ...
  svg
    ...
    .html(function (d) {
      ...
      var image = String(d.image_base64).replace(
        "<image ",
        `<image class=\"image_logo\" transform=\"translate(-${transformX},-70)\" `
      );
      return image;
    });

  svg.selectAll(".image_logo").attr("width", function (d) {
    var widthImg = 58;
  ...
  svg
    ...
    .attr("transform", function (d) {
      return `translate(0,-${height - y(d.measure_count) + 95})`;
    });
