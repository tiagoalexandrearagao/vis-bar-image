...
export function pieChart(params) {
  ...
  var transformWidthG =
    parseInt(width) + parseInt(margin.left) + parseInt(margin.right) - 50; //+ parseInt(margin.left)
  var transformHeightG =
    parseInt(height) + parseInt(margin.top) + parseInt(margin.bottom); //+ parseInt(margin.left)
  ...
  var svg = d3
    ...
    .attr(
      "transform",
      "translate(" + (transformWidthG + 50) + "," + transformHeightG + 100 + ")"
    ); //novo
