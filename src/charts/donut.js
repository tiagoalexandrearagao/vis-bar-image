...
export function donutChart(params) {
  ...
  svg
    ...
    .attr(
      "style",
      "font-family: 'Quicksand', sans-serif; font-weight: bold; font-size:18px; color:#333"
    );
  ...
  svg
    ...
    .attr(
      "style",
      "font-family: 'Quicksand', sans-serif; font-weight: normal; font-size:12px"
    );
  ...
  g.append("text") //add a label to each slice
    ...
    .attr(
      "style",
      "font-family: 'Quicksand', sans-serif; font-weight: bold; font-size:11px"
    )
    .text(function (d, i) {
      console.log("formattedData[i]", formattedData[i]);
      return (
  ...
  labels
    ...
    .attr(
      "style",
      "font-family: 'Quicksand', sans-serif; font-weight: normal; font-size:11px"
    )
    .each(function (d) {
